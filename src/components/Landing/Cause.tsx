      ...
      <div className="mx-auto flex max-w-[1239px] px-1 flex-col justify-center gap-10 relative">
        <div className="flex items-center gap-14">
            ...
            <div className="absolute bottom-[-70px] right-25 h-64 w-64 rounded-full bg-tertiary text-white flex items-center justify-center p-5">
              <div className="flex items-center gap-2">
                <div className="flex flex-col">
                  <span className="text-7xl font-ubuntu-condensed font-bold leading-14">
                    +2
                  </span>
                  <span className="text-7xl font-ubuntu-condensed font-bold  ml-5 leading-14">
                    M
                  </span>
                </div>
                <div className="max-w-[140px]">
                  <p className="text-[14px] leading-6 tracking-wide text-left font-pt-sans font-light text-white">
          ...
          <div className="max-w-lg mt-30">
            <p className="text-[16px] leading-[1.83] text-tertiary font-pt-sans">
